    ...
    async function loadByOwner() {
      ...
      try {
        ...
        if (typeof window !== "undefined") {
          ...
          localStorage.setItem("pageId", res.data.data[0].shopId);
        }
                      ...
                      <div className="max-w-[120px]">
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex flex-col ">
                            ...
                            <div className="truncate max-w-[110px] lg:max-w-[150px]">{page.ownerId}</div>
                          </div>
                          <button
                            type="button"
                      ...
                      <div className="max-w-[380px]">
                        <div className="flex items-center gap-3">
                          <div className="flex flex-col ">
                            ...
                            <span className="truncate  max-w-[200px] xl:max-w-[400px] block break-words">
                              {page.accessToken}
                            </span>
                          </div>
                          <button
                    ...
                    <td className="p-3 align-top cursor-pointer">
                      <div className="flex flex-col gap-2">
                        <div className="flex flex-col gap-1 justify-center text-center">
                          ...
                          <div onClick={() => togglePage(page._id)}>
                            <span
                              role="status"
                        ...
                        <div className="flex flex-col gap-1 justify-center text-center">
                          ...
                          <div className={`flex justify-center text-center items-center w-20 px-0 py-1 text-xs font-medium rounded-full ${statusClasses(page.connected)}`}>

                            <p className="px-0 w-full">{page.connected}</p>
                          </div>
                        </div>
                      </div>
                    </td>
